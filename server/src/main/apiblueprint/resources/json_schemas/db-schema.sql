...
CREATE TABLE form_questions (
  ...
  CONSTRAINT pk__ form_questions PRIMARY KEY (form_id, question_id),
...
CREATE TABLE form_instructors (
  ...
  CONSTRAINT pk__ form_questions PRIMARY KEY (form_id, instructor_id),
...
CREATE TABLE survey_ratings (
  ...
  CONSTRAINT pk__ survey_comment PRIMARY KEY (survey_id, form_id, question),
...
CREATE TABLE survey_instructors (
  ...
  CONSTRAINT pk__ survey_comment PRIMARY KEY (survey_id, form_id, instructor),
  CONSTRAINT fk__survey_comment__survey FOREIGN KEY (survey_id) REFERENCES survey_entry (id) ON DELETE CASCADE
);
